...
public class PenambilGambarCombobox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pilihan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Semesta", "Raya", "Indah" }));
        ...
        lblfoto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/git/EP-7-2.jpg"))); // NOI18N
        panelGambar.add(lblfoto, "0");

        lblworld.setIcon(new javax.swing.ImageIcon(getClass().getResource("/git/download (3).jpg"))); // NOI18N
        panelGambar.add(lblworld, "1");
